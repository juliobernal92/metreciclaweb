document.addEventListener('DOMContentLoaded', function() {
    ...
    function drawDailyChart() {
        fetch('/mr/controller/monthlyChartController.php')
            ...
            .then(data => {
                ...
                // Dibujar la tabla
                var table = new google.visualization.Table(document.getElementById('monthlyChart'));
                ...
                document.getElementById('monthlyTotalAmount').textContent = 'Valor Total: ' + formattedTotalMonto + ' Gs.'; 
            })
