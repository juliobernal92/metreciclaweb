document.addEventListener('DOMContentLoaded', function() {
    ...
    function drawDailyChart() {
        fetch('/mr/controller/weeklyChartController.php')
            ...
            .then(data => {
                ...
                // Dibujar la tabla
                var table = new google.visualization.Table(document.getElementById('weeklyChart'));
                ...
                document.getElementById('weeklyTotalAmount').textContent = 'Valor Total: ' + formattedTotalMonto + ' Gs.'; 
            })
